export const tools = [
  ...
  },
  {
    ...
    description:
      "Use this tool to convert temperatures from Fahrenheit (°F), the scale widely used in the US, to Celsius (°C), which is standard in most other countries and in scientific contexts. This helps in understanding temperature data from different regions, facilitating international communication, travel preparation, or scientific measurements by translating Fahrenheit values into the metric scale of Celsius.",
